...
try:
    ...
    # Minimal compatibility shim for slimmed lerobot builds that do not include policies/.
    lerobot_policies = types.ModuleType("lerobot.policies")
    lerobot_policies_normalize = types.ModuleType("lerobot.policies.normalize")
